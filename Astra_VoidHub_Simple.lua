...
local THEME = {
	Background = Color3.fromRGB(10, 12, 30),
	Section = Color3.fromRGB(16, 18, 38),
	Card = Color3.fromRGB(18, 22, 45),
	Accent = Color3.fromRGB(100, 160, 255),
	AccentDark = Color3.fromRGB(100, 160, 255),
	Text = Color3.fromRGB(100, 160, 255),
	DarkText = Color3.fromRGB(100, 160, 255),
	...
	FloatButton = Color3.fromRGB(10, 12, 30),
	ProgressBg = Color3.fromRGB(10, 12, 30),
...
local CONFIG_NAME, lastSaveTime, savedAnimate = "AstraVoidConfig", 0, nil
local floatButtons = {}
...
local function createESP(plr)
	...
	hitbox.Color3 = Color3.fromRGB(100, 160, 255)
...
local function updateToggleUI(name, state)
	...
	btn.state = state
	btn.track.BackgroundColor3 = state and Color3.fromRGB(100, 160, 255) or Color3.fromRGB(60, 60, 60)
...
local function setupChar(c)
	...
	if head then
		...
		speedLbl.TextColor3 = Color3.fromRGB(100, 160, 255)
...
HUDTitle.Text = "💫 ASTRA HUB 💫" HUDTitle.TextColor3 = THEME.Accent
...
Title.Text = "💫 ASTRA HUB 💫" Title.TextColor3 = THEME.Accent Title.Font = Enum.Font.GothamBold
...
local function createToggle(name, keyHintPC, keyHintController, defaultState, callback, order)
	...
	Track.BackgroundColor3 = defaultState and Color3.fromRGB(100, 160, 255) or Color3.fromRGB(60, 60, 60) Track.BorderSizePixel = 0
	...
	Btn.MouseButton1Click:Connect(function()
		...
		Track.BackgroundColor3 = ns and Color3.fromRGB(100, 160, 255) or Color3.fromRGB(60, 60, 60)
...
local function createCombatKeybindBadge(parent, actionName)
	...
	badge.BackgroundColor3 = Color3.fromRGB(100, 160, 255)
	...
	badge.MouseButton1Click:Connect(function()
		...
		conn = UserInputService.InputBegan:Connect(function(input)
			...
			if input.UserInputType == Enum.UserInputType.Keyboard then
				KEYBINDS[actionName].PC = input.KeyCode
				badge.BackgroundColor3 = Color3.fromRGB(100, 160, 255) listeningForKeybind = nil
				saveConfig() syncKeybindDisplays(actionName) conn:Disconnect()
			end
		end)
